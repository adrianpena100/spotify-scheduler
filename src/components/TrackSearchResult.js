...
export default function TrackSearchResult({ 
  ...
  const handleAddToPlaylist = () => {
    ...
    spotifyApi.addTracksToPlaylist(selectedPlaylist, [track.uri])
      .then(() => {
  ...
  return (
    <div className="d-flex align-items-center justify-content-between m-2" style={{ cursor: "pointer" }}>
      <div className="d-flex align-items-center" onClick={() => chooseTrack(track)}>
